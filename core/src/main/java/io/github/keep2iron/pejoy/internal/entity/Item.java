...
public class Item implements Parcelable {
    ...
    public Item(long id, String mimeType, Uri uri, long size, long duration) {
        this.id = id;
    ...
    public static Item valueOf(long id, Uri uri, String mimeType, long size) {
        return new Item(id, mimeType, uri, size, 0);
    }
